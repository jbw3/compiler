...
public:
    enum EOperator
    {
        eEqual                      = Token::EqualEqual,
        eNotEqual                   = Token::ExclaimEqual,
        eLessThan                   = Token::Less,
        eLessThanOrEqual            = Token::LessEqual,
        eGreaterThan                = Token::Greater,
        eGreaterThanOrEqual         = Token::GreaterEqual,
        eAdd                        = Token::Plus,
        eSubtract                   = Token::Minus,
        eMultiply                   = Token::Times,
        eDivide                     = Token::Divide,
        eRemainder                  = Token::Remainder,
        eShiftLeft                  = Token::LessLess,
        eShiftRightLogical          = Token::GreaterGreater,
        eShiftRightArithmetic       = Token::GreaterGreaterGreater,
        eBitwiseAnd                 = Token::Ampersand,
        eBitwiseXor                 = Token::Caret,
        eBitwiseOr                  = Token::Bar,
        eLogicalAnd                 = Token::AmpersandAmpersand,
        eLogicalOr                  = Token::BarBar,
        eAssign                     = Token::Equal,
        eAddAssign                  = Token::PlusEqual,
        eSubtractAssign             = Token::MinusEqual,
        eMultiplyAssign             = Token::TimesEqual,
        eDivideAssign               = Token::DivideEqual,
        eRemainderAssign            = Token::RemainderEqual,
        eShiftLeftAssign            = Token::LessLessEqual,
        eShiftRightLogicalAssign    = Token::GreaterGreaterEqual,
        eShiftRightArithmeticAssign = Token::GreaterGreaterGreaterEqual,
        eBitwiseAndAssign           = Token::AmpersandEqual,
        eBitwiseXorAssign           = Token::CaretEqual,
        eBitwiseOrAssign            = Token::BarEqual,
        eClosedRange                = Token::PeriodPeriod,
        eHalfOpenRange              = Token::PeriodPeriodLess,
        eSubscript                  = Token::OpenBracket,
    };
...
public:
    enum EOperator
    {
        eNegative    = Token::Minus,
        eComplement  = Token::Exclaim,
        eAddressOf   = Token::Ampersand,
        eDereference = Token::Times,
        eArrayOf     = Token::OpenBracket,
    };
