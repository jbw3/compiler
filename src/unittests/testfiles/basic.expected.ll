...
@strStruct4 = constant { i64, [3 x i8] } { i64 3, [3 x i8] c"abc" }
...
entry:
  ...
  store %str* bitcast ({ i64, [3 x i8] }* @strStruct4 to %str*), %str** %dup1
  store %str* bitcast ({ i64, [3 x i8] }* @strStruct4 to %str*), %str** %dup2
  ret %UnitType zeroinitializer
}
