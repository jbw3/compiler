...
bool UtilsTests::TestNumberConversion()
{
    vector<tuple<string, bool, bool, int64_t>> tests =
    {
        ...
        make_tuple("0h4", true, true, 0x4),
        make_tuple("0ha", true, true, 0xa),
        make_tuple("0hE", true, true, 0xE),
        make_tuple("0h10Ea5C", true, true, 0x10Ea5C),
        make_tuple("0h10ea_5C7a_39c8_", true, true, 0x10ea5C7a39c8),

        make_tuple("0b", true, false, 0),
        make_tuple("0o", true, false, 0),
        make_tuple("0h", true, false, 0),
        make_tuple("0b_", true, false, 0),
        make_tuple("0o__", true, false, 0),
        make_tuple("0h___", true, false, 0),
